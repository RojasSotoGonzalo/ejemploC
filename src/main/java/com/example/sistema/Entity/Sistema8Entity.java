...
@Entity
@Table(name = "sistema_8")
public class Sistema8Entity {
    @Id
    private Integer id;
    ...
    public Sistema8Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema8Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
