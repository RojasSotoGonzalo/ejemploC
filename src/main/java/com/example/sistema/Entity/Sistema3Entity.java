...
@Entity
@Table(name = "sistema_3")
public class Sistema3Entity {
    ...
    public Sistema3Entity() {
    }

    public Sistema3Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema3Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
