...
@Entity
@Table(name = "sistema_4")
public class Sistema4Entity {
    @Id
    private Integer id;
    ...
    public Sistema4Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema4Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
