...
@Entity
@Table(name = "sistema_5")
public class Sistema5Entity {
    ...
    public Sistema5Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema5Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
