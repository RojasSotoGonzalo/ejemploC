...
@Entity
@Table(name = "sistema_2")
public class Sistema2Entity {
    @Id
    private Integer id;
    ...
    public Sistema2Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema2Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
