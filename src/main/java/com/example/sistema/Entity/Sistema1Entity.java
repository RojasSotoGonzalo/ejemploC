...
@Entity
@Table(name = "sistema_1")
public class Sistema1Entity {
    @Id
    private Integer id;
    ...
    public Sistema1Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema1Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
