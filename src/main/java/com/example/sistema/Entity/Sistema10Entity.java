...
@Entity
@Table(name = "sistema_10")
public class Sistema10Entity {
    @Id
    private Integer id;
    ...
    public Sistema10Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema10Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
