...
@Entity
@Table(name = "sistema_9")
public class Sistema9Entity {
    @Id
    private Integer id;
    ...
    public Sistema9Entity(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH,
    ...
    public String toString() {
        return "Sistema9Entity [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT="
