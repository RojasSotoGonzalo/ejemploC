...
public class Sistema8DTO {
    ...
    public Sistema8DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
            String datoFPF, String estado) {
        this.id = id;
    ...
    public String toString() {
        return "Sistema8DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
