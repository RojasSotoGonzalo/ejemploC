...
public class Sistema7DTO {
    ...
    public Sistema7DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
    ...
    public String toString() {
        return "Sistema7DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
