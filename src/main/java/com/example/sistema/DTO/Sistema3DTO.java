...
public class Sistema3DTO {
    ...
    public Sistema3DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
    ...
    public String toString() {
        return "Sistema3DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
