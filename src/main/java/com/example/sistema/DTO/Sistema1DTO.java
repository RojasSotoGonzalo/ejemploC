...
public class Sistema1DTO {
    ...
    public String toString() {
        return "Sistema1DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
                + ", datoH=" + datoH + ", datoP=" + datoP + ", datoFPF=" + datoFPF + ", estado=" + estado + "]";
    }

    public Sistema1DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
