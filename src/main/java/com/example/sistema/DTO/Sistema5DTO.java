...
public class Sistema5DTO {
    ...
    public Sistema5DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
    ...
    public String toString() {
        return "Sistema5DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
