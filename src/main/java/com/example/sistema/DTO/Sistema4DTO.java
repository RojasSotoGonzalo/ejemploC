...
public class Sistema4DTO {
    ...
    public Sistema4DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
    ...
    public String toString() {
        return "Sistema4DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
