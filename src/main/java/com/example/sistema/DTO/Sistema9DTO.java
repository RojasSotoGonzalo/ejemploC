...
public class Sistema9DTO {
    ...
    public Sistema9DTO(Integer id, Integer gestion, Integer mes, Integer dia, String datoT, String datoH, Integer datoP,
    ...
    public String toString() {
        return "Sistema9DTO [id=" + id + ", gestion=" + gestion + ", mes=" + mes + ", dia=" + dia + ", datoT=" + datoT
